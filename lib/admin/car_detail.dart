...
class DetailCar extends StatefulWidget {
  ...
  const DetailCar({super.key, required this.car});
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                GestureDetector(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => EditCar(car: widget.car),)).then((value) async{
                                      setState(() {
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          buildSpecificationCar("Top Speed", widget.car.topSpeed.toString()),
                          buildSpecificationCar(
                            "Seat",
                            widget.car.seat.toString(),
                          ),
                          buildSpecificationCar("Fuel", widget.car.fuel),
                        ],
                      ),
                    ),
                  ],
